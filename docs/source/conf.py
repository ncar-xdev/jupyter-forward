...
extlinks = {
    'issue': ('https://github.com/NCAR/jupyter_forward/issues/%s', 'GH#'),
    'pr': ('https://github.com/NCAR/jupyter_forward/pull/%s', 'GH#'),
}
...
copyright = f'2020-{current_year}, Xdev'
author = u'Xdev'
...
latex_documents = [
    ('index', 'jupyter_forward.tex', u'jupyter-forward Documentation', u'Xdev', 'manual'),
]
...
man_pages = [('index', 'jupyter_forward', u'jupyter-forward Documentation', [author], 1)]
